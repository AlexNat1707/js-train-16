...
function filterStudentsByGrade(students, grade) {
  ...
  filteredStudents.forEach(student => console.log(`Ім'я студента: ${student.name}, Оцінка: ${student.grade}`));
...
function compareArrays(arr1, arr2) {
  ...
  const data1 = JSON.stringify(arr1);
  const data2 = JSON.stringify(arr2);
